...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	upstreamBalanceHTTPClient := repository.NewUpstreamBalanceHTTPClient()
	upstreamBalanceService := service.NewUpstreamBalanceService(accountRepository, upstreamBalanceHTTPClient)
	accountHandler := admin.ProvideAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, grokQuotaService, upstreamBalanceService)
